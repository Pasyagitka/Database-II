...
declare
    ...
    m_teacher       zei.teacher.teacher%type;
    m_teacher_name  zei.teacher.teacher_name%type;
    m_pulpit        zei.teacher.pulpit%type;
begin
    open curs_teacher;
    loop
...
declare
    ...
    rec_subject zei.subject%rowtype;
begin
    open curs_subject;
...
-- по строкам курсора.
declare
    cursor curs_auditorium (capacity_from zei.auditorium.auditorium%type, capacity_to zei.auditorium.auditorium%type) is 
    ...
    aum zei.auditorium.auditorium%type;
    cty zei.auditorium.auditorium_capacity%type;
begin
...
declare
    cursor curs_auditorium (capacity zei.auditorium.auditorium%type) is 
